...
description: Rigorous definitions of all language fundamental terms used in language design
---
...
2. Can only contain alphanumeric characters with `_` being the only special character allowed.
3. Must not exceed a particular amount of length
